...
var UpdateProfileAction = function () {
  function UpdateProfileAction(firebase, firebases) {
  ...
  _createClass(UpdateProfileAction, [{
    ...
    value: function dispatch(params) {
      ...
      return new Promise(function (resolve) {
        _this.restaurants.child(params.restaurantId).update(params.profile);
...
module.exports = function (firebase, firebases) {
  return new UpdateProfileAction(firebase, firebases);
};